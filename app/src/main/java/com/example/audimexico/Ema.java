...
public class Ema extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_button48 = findViewById(R.id.button48);
        btn_button49 = findViewById(R.id.button49);
        btn_button50 = findViewById(R.id.button50);
        btn_button51 = findViewById(R.id.button51);
        btn_button52 = findViewById(R.id.button52);
